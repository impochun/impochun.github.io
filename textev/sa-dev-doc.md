...
- **序號商品出貨**
  - 序號商品為系統自動出貨，流程：訂單成立(確認金流付款完成後) > 開立發票 > EC系統Email自動出貨(發送序號給會員)。
  - 自動Email出貨時，系統將自動從序號庫存中取用一組序號出貨，系統依先進先出概念出貨序號，即較早上傳的序號、要較先出貨給客戶。
...
| EC商品                   | 序號                           | 新增時間            | CSV檔名     | 狀態   | 出貨時間            | 訂購會員 | 訂單編號 | 刪除       |
| ------------------------ | ------------------------------ | ------------------- | ----------- | ------ | ------------------- | -------- | -------- | ---------- |
| 主檔編號、主檔內項目編號 | QW9JAJC8SDF (舉例, 非真實序號) | 2021-04-01 19:00:00 | KKBOX01.csv | 已出貨 | 2021-04-02 19:05:00 | 12345678 | TM0001   | 刪除此序號 |
| 主檔編號、主檔內項目編號 | QW8JC89SDN (舉例, 非真實序號)  | 2021-04-01 19:00:00 | KKBOX01.csv | 已出貨 | 2021-04-03 11:22:00 | 23456789 | TM0099   | 刪除此序號 |
| 主檔編號、主檔內項目編號 | 398J48WEFNS (舉例, 非真實序號) | 2021-04-01 19:00:00 | KKBOX01.csv | 未發送 | 無                  | 無       | 無       | 刪除此序號 |
| 主檔編號、主檔內項目編號 | QWOIMEIS(舉例, 非真實序號)     | 2021-04-01 19:00:00 | KKBOX01.csv | 未發送 | 無                  | 無       | 無       | 刪除此序號 |
| 主檔編號、主檔內項目編號 | QWOEOQIWE(舉例, 非真實序號)    | 2021-04-01 19:00:00 | KKBOX01.csv | 未發送 | 無                  | 無       | 無       | 刪除此序號 |

#### 電子禮券(宜睿)

- 宜睿禮券結帳與付款流程同一般商品，唯出貨是由系統自動出貨至會員Wallet中的票夾。
- 取券透過宜睿API進行。
- 需可設定禮券商品為獨立免運項目(單品結帳不受免運門檻限制皆免運, 因為是直接派送到Wallet)。
...
- **宜睿電子禮券於EC的使用情境**：
  1. 管理者將電子禮券商品新增/上架到EC系統
  2. 舊換新最終步驟EC核發禮券
  3. 消費者於EC購買禮券，並且核發禮券至消費者SA Wallet
